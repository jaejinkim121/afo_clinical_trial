...
class DataProcess:
    ...
    def gait_phase_pre_processing(
        ...
        mean_cycle_time_paretic = mean_stance_time_paretic / mean_cycle
        std_cycle_time_paretic = std_stance_time_paretic / mean_cycle
        ...
        mean_cycle_time_nonparetic = mean_stance_time_nonparetic / mean_cycle
        std_cycle_time_nonparetic = std_stance_time_nonparetic / mean_cycle
