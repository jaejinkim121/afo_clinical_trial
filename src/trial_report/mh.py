...
class ClinicalIndexMH:
    ...
    # @staticmethod
    # def get_symmetry_index_GRFmax(start_time, left_path, right_path,
    #                               paretic_path, non_paretic_path,
    #                               model_path_calib, model_path_grf,
    #                               save_path, size='280', paretic_side='L',
    #                               body_weight=float(100)):
    #     grf_class = GRF_predictor(
    #         start_time=float(start_time),
    #         leftPath=left_path,
    #         rightPath=right_path,
...
#             DataProcess.divider_data_by_gait_phase_df(df_paretic_raw_data,
#                                             gait_phase_paretic, "grf")
#         collection_nonparetic_raw_grf = \
#             DataProcess.divider_data_by_gait_phase_df(df_nonparetic_raw_data,
#                                             gait_phase_nonparetic, "grf")

#         DataProcess.graph_both_cycle_data(collection_paretic_raw_grf,
#                               collection_nonparetic_raw_grf,
